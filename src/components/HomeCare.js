...
class HomeCareParagraph extends Component{
    render(){
        return(
            ...
            Take 12-16 inches of dental floss and wrap it around your middle fingers, leaving about 2 inches (5cm) of floss between the hands.<br/>
            Using your thumbs and forefingers to guide the floss, gently insert the floss between teeth using a sawing motion.<br/>
            Curve the floss into a “C” shape around each tooth and under the gumline.  Gently move the floss up and down, cleaning the side of each tooth.<br/>
            ...
            <br/><br/>Use other dental aids as recommended by your dentist or dental hygienist:  interdental brushes, rubber tip stimulators, tongue cleaners, irrigation devices, fluoride, medicated rinses, etc., can all play a role in good dental home care.
            </p>
            </div>
