    ...
    render(){
        return(
            ...
            <p>It only takes twenty four hours for plaque that is not removed from your teeth to turn into calculus (tartar)!  Daily home cleaning helps control plaque and tartar formation, but those hard to reach areas will always need special attention.<br/><br/>
                    ...
                    Examination of diagnostic x-rays (radiographs): Essential for detection of decay, tumors, cysts, and bone loss. X-rays also help determine tooth and root positions.<br/>
                    Examination of existing restorations: Check current fillings, crowns, etc.<br/>
                    Examination of tooth decay: Check all tooth surfaces for decay.<br/>
                    Oral hygiene recommendations: Review and recommend oral hygiene aids as needed. (Electric toothbrushes, special periodontal brushes, fluorides, rinses, etc.)<br/>
