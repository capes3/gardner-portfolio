...
class PanoramicXRaysParagraph extends Component{
    render(){
        return(
            ...
            <p>Panoramic X-rays (also known as Panorex® or orthopantomograms) are wraparound photographs of the face and teeth.  They offer a view that would otherwise be invisible to the naked eye.  X-rays in general, expose hidden structures, such as wisdom teeth, reveal preliminary signs of cavities, and also show fractures and bone loss.<br/><br/>
            Panoramic X-rays are extraoral and simple to perform.  Usually, dental X-rays involve the film being placed inside the mouth, but panoramic film is hidden inside a mechanism that rotates around the outside of the head.<br/><br/>
            ...
            Assess patients with an extreme gag reflex.<br/>
            Evaluate the progression of TMJ.<br/>
            Expose cysts and abnormalities.<br/>
            Expose impacted teeth.<br/>
            Expose jawbone fractures.<br/>
            Plan treatment (full and partial dentures, braces and implants).<br/>
            Reveal gum disease and cavities.<br/>
            How are panoramic X-rays taken?<br/>
